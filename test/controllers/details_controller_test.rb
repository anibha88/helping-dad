...
class DetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post details_url, params: { detail: { address: @detail.address, cust_name: @detail.cust_name, phone: @detail.phone, shop_name: @detail.shop_name, status: @detail.status } }
    end
  ...
  test "should update detail" do
    patch detail_url(@detail), params: { detail: { address: @detail.address, cust_name: @detail.cust_name, phone: @detail.phone, shop_name: @detail.shop_name, status: @detail.status } }
